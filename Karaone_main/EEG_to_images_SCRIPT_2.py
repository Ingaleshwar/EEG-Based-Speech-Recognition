...
def main(raw=False, filt=True, IC_A=False, beta=False):
    PATH_TO_DATA = 'E:\\MP\\Major Project - ISR MATLAB Code\\Major Project - ISR MATLAB Code\\data\\ImaginedSpeechData\\'   #Set as appropriate
    SUBJECTS = ['MM21']
