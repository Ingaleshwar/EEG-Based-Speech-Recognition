...
class EEGWorkflowGUI(QWidget):
    ...
    def load_raw_eeg_data(self):
        ...
        PATH_TO_DATA = "C:\\Users\\Aditya\\Desktop\\major_demo\\data\\"
        mds.Dataset(subject)
    ...
    def plot_raw_signal(self):
        ...
        file = rf'C:\Users\Aditya\Desktop\major_demo\data\{subject}\plot_files_raw.pkl'
    ...
    def plot_filtered_signal(self):
        subject = self.selected_option
        file = rf'C:\Users\Aditya\Desktop\major_demo\data\{subject}\plot_files_filtered.pkl'
    ...
    def auto_artifact_rejection(self):
        ...
        EEG = pop_loadset('filename', 'processed_data_AA_with_ICA15.set', 'filepath', 'C:/Users/Aditya/Downloads/Skull/15/');
    ...
    def inspect_components(self):
        ...
        string2 = Template(r"""
        [ALLEEG EEG CURRENTSET ALLCOM] = eeglab;
        EEG = pop_loadset('filename','processed_data_AA_with_ICA.set','filepath','C:\Users\Aditya\Desktop\major_demo\data\$subject\');
        [ALLEEG, EEG, CURRENTSET] = eeg_store( ALLEEG, EEG, 0 );
        EEG = pop_iclabel(EEG, 'default');
        [ALLEEG, EEG, CURRENTSET] = eeg_store(ALLEEG, EEG, CURRENTSET);
        addpath(genpath('C:\Users\Aditya\AppData\Roaming\MathWorks\MATLAB Add-Ons\Collections\EEGLAB\plugins\ICLabel\viewprops'));
    ...
    def svm_prediction(self):
        ...
        model_filename = r'C:\Users\Aditya\Desktop\major_demo\data\best_svm_model.joblib'
        path = r'C:\Users\Aditya\Desktop\major_demo\data'
